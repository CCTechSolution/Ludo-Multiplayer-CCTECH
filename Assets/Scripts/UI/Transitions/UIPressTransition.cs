...
namespace DuloGames.UI
{
    ...
    public class UIPressTransition : MonoBehaviour, IEventSystemHandler, IPointerDownHandler, IPointerUpHandler 
    {
        ...
        [SerializeField]
        private Selectable m_TargetSelectableObject;
        /// <summary>
        ...
        protected virtual void DoStateTransition(VisualState state, bool instant)
        {
            ...
            if (m_TargetSelectableObject && !m_TargetSelectableObject.interactable){
                state = VisualState.Disabled;
            }
            //Debug.Log("m_TargetSelectableObject.interactable= "+ m_TargetSelectableObject.interactable);
