...
namespace DuloGamesEditor.UI
{
    ...
    public class UIPressTransitionEditor : Editor
    {
        ...
        private SerializedProperty m_TargetSelectableObjectProperty;
        protected void OnEnable()
        {
            ...
            this.m_TargetSelectableObjectProperty = this.serializedObject.FindProperty("m_TargetSelectableObject");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (transition == UIHighlightTransition.Transition.ColorTint || transition == UIHighlightTransition.Transition.SpriteSwap || transition == UIHighlightTransition.Transition.TextColor)
            {
                ...
                EditorGUILayout.PropertyField(this.m_TargetSelectableObjectProperty, new GUIContent("Target Selectable Object"));
