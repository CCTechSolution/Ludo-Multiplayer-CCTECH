...
namespace NiobiumStudios
{
    ...
    **/
    public class DailyRewards : DailyRewardsCore<DailyRewards>
    {
        ...
        // Needed Constants
        private const string LAST_REWARD_TIME = "LastDailyRewardTime";
        private const string LAST_REWARD = "LastDailyReward";
        ...
        public void CheckRewards()
        {
            ...
            notification.SetActive(availableReward > 0);
