...
namespace NiobiumStudios
{
    ...
    public class DailyRewardsEditor : Editor 
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            SerializedProperty iSshown = serializedObject.FindProperty("isShown");
            SerializedProperty notification = serializedObject.FindProperty("notification");
            EditorGUILayout.PropertyField(iSshown, new GUIContent("Is Shown"));
            EditorGUILayout.PropertyField(notification, new GUIContent("Notification"));
