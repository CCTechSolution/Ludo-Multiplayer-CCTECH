...
public class EmojiShopController : MonoBehaviour
{
    ...
    public void fillData(int i)
    {
        ...
        int price = Config.emojisPrices[i];
        this.price = price;
        ...
        if (GameManager.Instance.PlayerData.Emoji != null &&
            GameManager.Instance.PlayerData.Emoji.Length > 0 && GameManager.Instance.PlayerData.Emoji.Contains("'" + i + "'"))
        {
