...
public class ControlAvatars : MonoBehaviour
{
    ...
    public void reset()
    {
        ...
        if (GameManager.Instance.Type == GameType.Private && !GameManager.Instance.JoinedByID)
        {
    ...
    public void ShareCode()
    {
      //  NativeShare share = new NativeShare();
        string shareText = string.Format(Config.SharePrivateLinkMessage + " " + RoomIDText.GetComponent<Text>().text + "\n\n" + Config.SharePrivateLinkMessage2 ,Application.productName, Application.productName);
#if UNITY_ANDROID
        shareText += "https://play.google.com/store/apps/details?id=" + Config.AndroidPackageName;
#elif UNITY_IOS
        shareText += "https://itunes.apple.com/us/app/apple-store/id" + Config.ITunesAppID;
#endif
       // NativeShare.instance.ShareText(shareText);
    }
    ...
    public void ShareRoomCode()
    {
        ...
        string shareText = string.Format(Config.SharePrivateLinkMessage + " " + RoomIDText.GetComponent<Text>().text + "\n\n" + Config.SharePrivateLinkMessage2, Application.productName, Application.productName);
        //NativeShare.instance.ShareText(shareText);
        Debug.Log("Room Code is " + PrivateRoomCode.text + shareText);
    }
    ...
    public void pdateRoomID(string id)
    {
    ...
    {
        PlayFabManager.Instance.imReady = true;
    ...
    public IEnumerator updateMessageBubbleText()
    {
        ...
        if (!GameManager.Instance.opponentDisconnected)
            messageBubbleText.GetComponent<Text>().text = Config.waitingForOpponent + " " + waitingOpponentTime;
    ...
    public void cancelMatching()
    {
        ...
        Invoke(nameof(cancelGameInvoke), 3.0f);
    }
