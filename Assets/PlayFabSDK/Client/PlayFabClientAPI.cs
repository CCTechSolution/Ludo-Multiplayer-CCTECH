...
namespace PlayFab
{
    ...
    public static class PlayFabClientAPI
    {
        ...
        public static void AcceptTrade(AcceptTradeRequest request, Action<AcceptTradeResponse> resultCallback, Action<PlayFabError> errorCallback, object customData = null, Dictionary<string, string> extraHeaders = null)
        {
            ...
            if (!context.IsClientLoggedIn()) { OnException(new PlayFabException(PlayFabExceptionCode.NotLoggedIn, "Must be logged in to call this method")); return; }
        ...
        private static void OnException(PlayFabException playFabException)
        {
           UnityEngine.Debug.Log(playFabException.Message);
        }
    }
}
